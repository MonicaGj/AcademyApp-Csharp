...
namespace AcademyApp
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Console.WriteLine("1.Show all students; 2.Print grades; 3.Show subjects");
                ...
                else if(trainerOption == "2")
                {
                    ...
                    foreach (var student in users)
                    {
                        if (student.Role == Role.Student && (student.FirstName.Contains(studentName) || student.LastName.Contains(studentName)))
                        {
